    ...
    for i in pbar:
        ...
        if (i % 1000 == 0 and i > 0) or i == config.n_episodes - 1:
            ...
            plot_training_history(
                ...
                ["DRL Agent total_reward ","DRL Agent Critical Reward",  "NF", "FF", "FFD"],
                outfilepath="/Users/henokbirru/Documents/EDISS/CourseMaterials/DIE/CADES/implementation/bin-packing-drl/experiments/policy_dnn_10_20_NF_3_Decoder_2L.png",
                moving_avg_window=100,
            )


    # Save key training metrics
    if not os.path.isfile("/Users/henokbirru/Documents/EDISS/CourseMaterials/DIE/CADES/implementation/bin-packing-drl/experiments/experiments.csv"):
        col_headers = list(vars(config).keys())
        col_headers.extend(["agent_reward", "nf_reward", "ff_reward", "ffd_reward"])
        with open("/Users/henokbirru/Documents/EDISS/CourseMaterials/DIE/CADES/implementation/bin-packing-drl/experiments/experiments.csv", "w") as f:
            writer = csv.writer(f)
            writer.writerow(col_headers) 
    
    with open("/Users/henokbirru/Documents/EDISS/CourseMaterials/DIE/CADES/implementation/bin-packing-drl/experiments/experiments.csv", "a") as f:
        writer = csv.writer(f)
